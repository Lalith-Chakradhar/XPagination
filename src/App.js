...
function App() {
  ...
  const indexOfLastEmployee = Math.min(currentPage * employeesPerPage, totalEmployees);
  const indexOfFirstEmployee = indexOfLastEmployee - employeesPerPage;
  const currentPageEmployees = employeeData.slice(indexOfFirstEmployee,indexOfLastEmployee);
