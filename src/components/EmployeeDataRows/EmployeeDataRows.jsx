    ...
    <table className={styles.employeeTable}>
      <thead>
        <tr className={styles.tableHeading}>
          <td style={{width:"70px", height:"43px", marginLeft:"10px"}}>ID</td>
      ...
      {employeeData.map((employees) => (
        ...
        <td style={{width:"70px", height:"43px", marginLeft:"10px"}}>{employees.id}</td>
        <td style={{width:"370px", marginLeft:"30px"}}>{employees.name}</td>
        <td style={{width:"430px", marginRight:"60px"}}>{employees.email}</td>
